...
const DEFAULTS = {
  title: 'Mais do que serviços. Uma parceria.',
  subtitle: 'Nossos diferenciais',
  image: 'https://picsum.photos/seed/equipe/800/1000',
  items: [
...
type DiferenciaisData = typeof DEFAULTS;

export default function DiferenciaisSection({ data }: { data?: Partial<DiferenciaisData> | null }) {
    ...
    <section id="diferenciais" className="section-py bg-branco relative">
      <div className="container-custom grid lg:grid-cols-2 gap-16 items-center">
        ...
        <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          ...
          <Link href="/sobre" className="inline-flex items-center text-roxo font-medium hover:underline underline-offset-4 transition-all">
        ...
        >
          ...
          >
            <div className="w-12 h-12 bg-ambar/20 rounded-full flex items-center justify-center text-ambar text-2xl">★</div>
            <div>
